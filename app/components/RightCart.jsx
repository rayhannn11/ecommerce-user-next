...
const RightCart = ({ total, email, cart }) => {
  ...
  return (
    <div className="w-full max-h-[400px] flex flex-col justify-end text-black lg:ml-[50px] ">
      ...
      {/* Button */}
      {cart.length === 0 ? (
        <button className="bg-neutral-100 text-[#9e9b9b] font-[bold] mt-5 p-5 rounded-[30px] border-[none] cursor-default">
          CHECKOUT SEKARANG
        </button>
      ) : (
        <button
          className="bg-[#111111] text-[white] font-[bold] cursor-pointer mt-5 p-5 rounded-[30px] border-[none] active:bg-[#030303]"
